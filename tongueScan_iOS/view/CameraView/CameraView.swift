                ...
                ZStack {
                    ...
                    ZStack{
                        ...
                        Button(action: {
                            ...
                            Image(systemName:"arrow.triangle.2.circlepath.camera").resizable().frame(width: 35, height: 30).foregroundColor(.white)
                        }
                        .position(x:geometry.size.width*0.8, y: geometry.size.height/1.1)
                        .buttonStyle(ClickScaleUp())
                    }
                        ...
                        ZStack{
                            ...
                            HStack(){
                                ...
                                Button(action: {
                                    ...
                                    if (!vm.uploading){
                                        Task{
                                            await vm.uploadImage(token: tongueScan_iOSApp.loginModel?.token ?? "")
                                        }
                                    }
                                }){
                                    VStack{
